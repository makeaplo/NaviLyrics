...
struct LyricGlowTextRenderer: TextRenderer {
    ...
    var displayPadding: EdgeInsets {
        ...
        return EdgeInsets(
            ...
            // Horizontal display padding changes the origin SwiftUI supplies
            // to TextRenderer. These lyric rows already reserve their exact
            // layout width, so that shifted origin pushes the first glyphs
            // outside the ScrollView on narrow screens. Keep the horizontal
            // origin stable; scrollClipDisabled still lets glow overflow.
            leading: 0,
